        ...
        <div className="min-h-screen bg-gradient-to-br from-brand-dark via-brand to-primary-700 flex items-center justify-center p-4">
            ...
            <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden">
                ...
                <div className="bg-gradient-to-br from-brand-dark to-brand p-10 text-white text-center relative overflow-hidden">
                    ...
                    <h1 className="text-4xl font-bold mb-2 tracking-tight">PDV PELG</h1>
                    <p className="text-blue-100 text-sm font-medium">Sistema de Gestão Empresarial</p>
                </div>
                ...
                <form onSubmit={handleLogin} className="p-8 space-y-6">
                    ...
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-4 bg-white text-gray-500 font-medium">ou entre com email</span>
                        </div>
                    </div>
                    ...
                    <div className="text-center space-y-3">
                        <p className="text-sm text-gray-600">
                            Não tem uma conta?{' '}
                            <Link to="/register" className="text-brand hover:text-brand-dark font-bold transition-colors">
                                Criar conta grátis
                            </Link>
                        </p>
